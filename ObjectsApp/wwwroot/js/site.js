...
class App {
    ...
    update_snapshot(image) {
        // display results in page
        //var data_uri = "CameraPhotos/image.jpg";
        var data_uri = "CameraPhotos\\" + image;
        var style = "width: 500px; height: 360px;";
        document.getElementById('results').innerHTML = '<img src="' + data_uri + '" style="' + style + '" />';
    };

    get_final_image(image) {
        // display results in page
        //var data_uri = "CameraPhotos/imageWithObjects.jpg";
        var data_uri = "CameraPhotos\\" + image;
        var style = "width: 500px; height: 360px;";
        document.getElementById('ImageResult').innerHTML = '<img src="' + data_uri + '" style="' + style + '" />';
    };
}